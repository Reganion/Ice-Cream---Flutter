...
class _CompleteOrderRow extends StatelessWidget {
  ...
  const _CompleteOrderRow({required this.label, required this.value});
...
class _CompleteActionIconButton extends StatelessWidget {
  ...
  const _CompleteActionIconButton({required this.icon, this.onTap});
